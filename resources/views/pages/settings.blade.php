    ...
    <div class="row">
        <div class="col-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('user.settings.info') }}" method="POST">
                        @csrf
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input name="username" type="text" value="{{ Auth::user()->username }}" class="form-control @error('username') is-invalid @enderror">
                                @error('username')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <input type="password" class="form-control hover-to-see" value="{{ Auth::user()->access_token }}" id="personnal-token" readonly>
        ...
        <div class="col-4">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('user.settings.display') }}" method="POST">
                        @csrf
                        <div class="row mb-3">
                            <label class="col-sm-6 col-form-label"><i data-feather="image"></i>Pictures</label>
                            <div class="col-sm-6 text-end btn-group">
                                <input type="radio" class="btn-check" name="display.image" id="1.default" value="default" autocomplete="off" @if(Auth::user()->settings()->get('display.image') == 'default') checked @endif>
                                <label class="btn btn-outline-secondary" for="1.default">Default</label>
                                <input type="radio" class="btn-check" name="display.image" id="1.raw" value="raw" autocomplete="off" @if(Auth::user()->settings()->get('display.image') == 'raw') checked @endif>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6 text-end btn-group">
                                <input type="radio" class="btn-check" name="display.video" id="2.default" value="default" autocomplete="off" @if(Auth::user()->settings()->get('display.video') == 'default') checked @endif>
                                <label class="btn btn-outline-secondary" for="2.default">Default</label>
                                <input type="radio" class="btn-check" name="display.video" id="2.raw" value="raw" autocomplete="off" @if(Auth::user()->settings()->get('display.video') == 'raw') checked @endif>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6 text-end btn-group">
                                <input type="radio" class="btn-check" name="display.audio" id="3.default" value="default" autocomplete="off" @if(Auth::user()->settings()->get('display.audio') == 'default') checked @endif>
                                <label class="btn btn-outline-secondary" for="3.default">Default</label>
                                <input type="radio" class="btn-check" name="display.audio" id="3.raw" value="raw" autocomplete="off" @if(Auth::user()->settings()->get('display.audio') == 'raw') checked @endif>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6 text-end btn-group">
                                <input type="radio" class="btn-check" name="display.text" id="4.default" value="default" autocomplete="off" @if(Auth::user()->settings()->get('display.text') == 'default') checked @endif>
                                <label class="btn btn-outline-secondary" for="4.default">Default</label>
                                <input type="radio" class="btn-check" name="display.text" id="4.raw" value="raw" autocomplete="off" @if(Auth::user()->settings()->get('display.text') == 'raw') checked @endif>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6 text-end btn-group">
                                <input type="radio" class="btn-check" name="display.pdf" id="5.default" value="default" autocomplete="off" @if(Auth::user()->settings()->get('display.pdf') == 'default') checked @endif>
                                <label class="btn btn-outline-secondary" for="5.default">Default</label>
                                <input type="radio" class="btn-check" name="display.pdf" id="5.raw" value="raw" autocomplete="off" @if(Auth::user()->settings()->get('display.pdf') == 'raw') checked @endif>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6 text-end btn-group">
                                <input type="radio" class="btn-check" name="display.zip" id="6.default" value="default" autocomplete="off" @if(Auth::user()->settings()->get('display.zip') == 'default') checked @endif>
                                <label class="btn btn-outline-secondary" for="6.default">Default</label>
                                <input type="radio" class="btn-check" name="display.zip" id="6.raw" value="raw" autocomplete="off" @if(Auth::user()->settings()->get('display.zip') == 'raw') checked @endif>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6 text-end btn-group">
                                <input type="radio" class="btn-check" name="display.file" id="7.default" value="default" autocomplete="off" @if(Auth::user()->settings()->get('display.file') == 'default') checked @endif>
                                <label class="btn btn-outline-secondary" for="7.default">Default</label>
                                <input type="radio" class="btn-check" name="display.file" id="7.raw" value="raw" autocomplete="off" @if(Auth::user()->settings()->get('display.file') == 'raw') checked @endif>
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    ...
                    <div class="d-grid">
                        <a class="btn btn-icon btn-outline-{{ Cookie::get('theme', 'dark') == 'dark' ? 'light' : 'dark' }}" href="{{ route('user.external.sharex') }}">
